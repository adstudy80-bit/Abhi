...
XP: {fix_num(data['xp'])}\n\n
°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[FFB300][b][c]MADE BY ABHI:THE BIG BULL
            """
            return msg
        else:
            msg = """
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]DEVELOPER: [FFFFFF]ABHI THE BIG BULL[00FF00]!!
"""
...
async def MaiiiinE():
    Uid , Pw = '4291706772','16B73095DFF7767CE9EC061CB81E546AEF813EF6317FB9959F67005B25805C16'
    ...
    os.system('clear')
    print(render('ABHI : THE BIG BULL', colors=['white', 'green'], align='center'))
    print('')
    #print(' - ReGioN => {region}'.format(region))
    print(f" - BoT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | OnLinE ! (:")    
    print(f" - DEVELOPER >ABHI : THE BIG BULL| INSTA:a_x_student TELEGRAM:@ bigbullabhi880 ! (:")    
